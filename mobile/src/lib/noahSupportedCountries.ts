 ...
 * Noah will not facilitate services for these jurisdictions
 */
...
/**
 * Countries that Noah does NOT support (Controlled)
 * Noah will not facilitate services except for specially approved programs
 */
...
/**
 * Check if a country code (ISO alpha-2) is supported by Noah
...
/**
 * Filter an array of countries to only include Noah-supported ones
 */
