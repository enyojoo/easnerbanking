...
export function mapUsersRowToUser(ru: Record<string, unknown>): User {
  ...
  return {
    ...
    verification_status: (ru.verification_status as string) ?? null,
    verification_provider: (ru.verification_provider as string) ?? null,
    bridge_cutover_required_at: (ru.bridge_cutover_required_at as string) ?? null,
    bridge_cutover_deadline_at: (ru.bridge_cutover_deadline_at as string) ?? null,
    ...
    bridge_kyc_status: (ru.bridge_kyc_status as string) ?? null,
    bridge_customer_id: (ru.bridge_customer_id as string) ?? null,
