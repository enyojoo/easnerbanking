...
export const recipientCatalog: RecipientCatalogEntry[] = [
  ...
  { countryCode: 'RW', countryName: 'Rwanda', currencyCode: 'RWF', currencyName: 'Rwandan Franc', recipientType: 'mobile_money', status: 'supported', providers: ['MTN Rwanda'], fields: mobileMoneyFields },
