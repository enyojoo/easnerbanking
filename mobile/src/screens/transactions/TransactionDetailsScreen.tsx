...
export default function TransactionDetailsScreen({ navigation, route }: NavigationProps) {
  ...
  const inboundReceive = useMemo(() => {
    ...
    return resolveInboundReceiveDetail({
      ...
      counterparty_address: transaction.counterparty_address ?? transaction.metadata?.counterparty_address,
      ...
      settled_at: transaction.settled_at ?? transaction.completed_at,
