...
const ROUTE_TITLES: Record<string, string> = {
  ...
  AddRecipientType: 'Add Recipient',
  AddBankRecipient: 'Add Bank Account',
  AddMobileRecipient: 'Add Mobile Money',
  AddWalletRecipient: 'Add Wallet Address',
  AddEasenetRecipient: 'Add Easetag',
  Profile: 'Profile',
  ProfileEdit: 'Profile',
  Support: 'Support',
