...
export function KycRequiredDocumentsNotice({ style }: Props) {
  ...
  /** Fixed chrome above/below the scroll body (grabber, title, CTA, gaps). */
  const chromeHeight = 8 + 4 + 16 + 44 + 12 + 56 + 8
  const bodyMaxHeight = Math.max(180, sheetMaxHeight - chromeHeight - bottomPad)
  ...
  return (
    <>
      ...
      >
        <View style={[styles.modalPanel, { paddingBottom: bottomPad }]}>
