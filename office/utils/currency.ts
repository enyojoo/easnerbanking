...
const STATIC_TS = "2020-01-01T00:00:00.000Z"

export const currencies: Currency[] = [
  {
    id: "office-static-usd",
    code: "USD",
    name: "US Dollar",
    symbol: "$",
    status: "active",
...
export const getExchangeRate = (from: string, to: string): ExchangeRate | null => {
  return exchangeRates.find((r) => r.from_currency === from && r.to_currency === to) || null
}
