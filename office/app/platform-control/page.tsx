...
const TABS = ["currencies", "settings", "health", "audit", "noah", "industry"] as const
    ...
    <OfficeDashboardLayout>
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Currencies, settings, integrations, audit, and Noah tools</p>
        </div>
