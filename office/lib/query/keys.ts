...
export const officeKeys = {
  ...
  statementsRoot: () => [...officeKeys.root, "statements"] as const,
  ...
  currenciesRoot: () => [...officeKeys.root, "currencies"] as const,
  ...
  processingFeeScheduleRoot: () => [...officeKeys.root, "processing-fee-schedule"] as const,
  processingFeeSchedule: (scope: string) => [...officeKeys.root, "processing-fee-schedule", scope] as const,
  processingFeeOverrideRoot: () => [...officeKeys.root, "processing-fee-override"] as const,
