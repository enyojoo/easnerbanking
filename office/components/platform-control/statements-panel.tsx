...
export function StatementsPanel() {
  ...
  const query = useOfficeStatementsList({ q, currency, scope })
      ...
      <Card>
        <CardContent className="p-0">
          <Table className="table-fixed w-full">
            <TableHeader>
              <TableRow>
                <TableHead className="w-[23%]">Statement ID</TableHead>
                <TableHead className="w-[22%]">Generated</TableHead>
                <TableHead className="w-[23%]">Who</TableHead>
                ...
                : statements.map((row) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell className="whitespace-nowrap tabular-nums">
                        {formatOfficeTimestamp(row.created_at)}
                      </TableCell>
                      <TableCell>
