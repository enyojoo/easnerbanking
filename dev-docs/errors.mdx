...
- `400` `transfer_failed` with insufficient funds — fund the platform account (Checkout or a test credit path), then retry with a **new** idempotency key only if you intend a new send.
