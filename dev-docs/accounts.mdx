---
title: Accounts
description: A currency view of your customer’s custodial stablecoin vault.
icon: wallet
---

An account is not a float you invent. It is the **USD or EUR view** of a custodial vault Easner opens for that customer.
...
You never receive a private key. Deposit addresses and bank details are issued against this vault. Sends debit `available` and leave from it.
...
Live bank details, chain addresses, and onramp require `verification_status = approved`. Test skips that.
