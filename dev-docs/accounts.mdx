...
Checkout does **not** credit these accounts. Checkout is online payments on your website; those funds land on your business balance. [Receive](/receive) credits the `acct_` you pass.
...
Live bank details, chain addresses, and onramp require the customer’s [verification](/customers#start-verification) (`verification_status = approved`) — KYC or KYB on your app. Test skips that.
