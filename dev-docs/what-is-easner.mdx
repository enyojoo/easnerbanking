...
The model is one isolated vault per customer — receive in, send out. Checkout is separate: take online payments on your website; those funds land on your business balance.
...
| **Checkout** | Your business balance | [Online payments](/checkout) on your website |

They share a secret key and Console. They do not share a balance.

Checkout is online payments on your website. Paid funds land on **your** business balance — the same place as invoices and payment links, not a customer vault. That is not Receive.
...
<Steps>
  ...
  <Step title="Take payments on your site">
    Optional. [Checkout](/checkout) on your website. Funds land on **your** business balance. Fulfil from `checkout.completed`.
  </Step>
</Steps>
...
| Checkout session | `cs_` | Checkout | A payment on your website |
