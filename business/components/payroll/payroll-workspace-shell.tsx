...
function PayrollWorkspaceContent({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-7 sm:px-6 sm:py-8">
      <header className="mb-5 flex min-h-[72px] flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
