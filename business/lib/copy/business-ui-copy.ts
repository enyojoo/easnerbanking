...
export const COLLECTIONS_COPY = {
  ...
  phaseGetReadyBlurb: "Confirm online payments and fee settings.",
  phaseConnect: "Connect site",
  phaseConnectBlurb: "Add your website and return URLs.",
  phaseIntegrate: "Integrate",
  phaseIntegrateBlurb: "Get keys and add checkout to your page.",
  phaseVerify: "Verify",
  phaseVerifyBlurb: "Add a webhook, test, then go live.",
  ...
  stepTestTitle: "Test payment",
  stepTestBlurb: "Same form customers see. Nothing is charged.",
