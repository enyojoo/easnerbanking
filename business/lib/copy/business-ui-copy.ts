...
export const PAGE_COPY = {
  ...
  checkout: {
    ...
    intro: "Add card and bank payments to your site.",
  },
} as const
...
export const COLLECTIONS_COPY = {
  ...
  editWebsite: "Edit",
  removeWebsite: "Remove",
  removeWebsiteTitle: "Remove this website?",
  removeWebsiteBody: "Checkout keys will no longer work from this origin.",
  setupBack: "Website checkout",
  setupCreateTitle: "Add website",
  setupEditTitle: "Edit website",
  settingUp: "Setting up",
  needTheCode: "Need the code?",
  addToWebsite: "Integration guide",
  testOnYourWebsite:
    "Test on your website with card 4242 4242 4242 4242. That payment and a webhook 200 unlock live.",
  next: "Next",
  doneEditing: "Done",
  guideTitle: "Integration guide",
  guideBlurb: "Copy these into your site. Close to return to this website.",
  stepCodeTitle: "Code for this step",
  originLabel: "Origin",
  returnUrlsLabel: "Return URLs",
  keysLabel: "Keys",
  webhookLabel: "Webhook",
  lastUsedNever: "never",
  webhookNoDeliveries: "No deliveries yet",
  successUrlSaved: "Success URL saved",
  cancelUrlSaved: "Cancel URL saved",
  noCancelUrl: "No cancel URL",
  siteNotFound: "This website isn’t on Checkout.",
  siteNotFoundCta: "Back to websites",
  emptyTitle: "No links yet",
  emptyBody: "Create a link customers can pay without an invoice.",
  emptyCta: "Create your first link",
  otherWays: "Other ways to collect",
  otherInvoices: "Invoices",
  otherCheckout: "Website checkout",
  tabAll: "All",
  tabIncomplete: "Incomplete",
  tabOneTime: "One-time",
  tabRecurring: "Recurring",
  tabStablecoin: "Stablecoin",
  searchPlaceholder: "Search links",
  columnLink: "Link",
  columnType: "Type",
  columnAmount: "Amount",
  columnPayments: "Payments",
  emptySearchLinks: "No links match this view",
  emptyActiveLinks: "No active links.",
  emptyClosedLinks: "No closed links.",
  ...
  masterOffTitle: "Online payments are turned off",
  ...
  statusLive: "Live mode",
  statusWebhookOn: "Webhook configured",
  statusWebhookOff: "Webhook not set",
  editIntegration: "Edit integration",
  notBuildingSite: "Not building a site?",
  openPaymentLinks: "Open payment links",
  loadError: "Couldn’t load setup",
  retry: "Retry",
  dashboardTitle: "Quick reference",
  phaseGetReady: "Get ready",
  phaseConnect: "Connect site",
  phaseIntegrate: "Integrate",
  phaseGoLive: "Go Live",
  stepReadyTitle: "Confirm online payments",
  stepReadyBlurb: "Same setup as invoice Pay online.",
  stepFeesTitle: "Processing fees",
  stepFeesBlurb: "Who pays the fee is set in Payments settings.",
  stepWebsiteTitle: "Add your website",
  stepWebsiteBlurb: "Only these addresses can use your keys.",
  stepUrlsTitle: "Return URLs",
  stepUrlsBlurb: "Where customers go after paying or backing out.",
  stepKeysTitle: "API keys",
  stepKeysBlurb: "Publishable key in the page. Secret key on your server.",
  stepSnippetTitle: "Add the payment form",
  ...
  columnSource: "Source",
  sourceEmbed: "Website",
  sourcePaymentLink: "Payment link",
  payerEmailLabel: "Email",
  payerEmailPlaceholder: "you@example.com",
  payerEmailRequired: "Enter your email to continue",
  stepLiveTitle: "Go live",
  stepLiveBlurb: "Switch your site to live keys when you are ready.",
...
export const INVOICE_SETTINGS_COPY = {
  ...
  onlinePaymentsHelp: "Show card and bank checkout on invoice customer pages",
...
export const PAYMENTS_SETTINGS_COPY = {
  ...
  masterIntro: "One switch for invoices, links, and website checkout.",
...
export const SETTINGS_CARD_COPY = {
  ...
  legalEntity: "Your verified company registration details.",
  registeredAddress: "Provided when you verify your business",
