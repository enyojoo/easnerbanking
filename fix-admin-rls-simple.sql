-- Simple RLS Fix for Admin Users
-- This creates simpler policies that should work

-- =====================================================
-- 1. Fix USERS table - allow admin users to see all users
-- =====================================================
...
-- Admin users can see all users (check both metadata fields)
...
-- =====================================================
-- 2. Fix TRANSACTIONS table - allow admin users to see all transactions
-- =====================================================
...
-- =====================================================
-- 3. Fix CURRENCIES table - allow admin users to see all currencies
-- =====================================================
...
-- =====================================================
-- 4. Fix EXCHANGE_RATES table - allow admin users to see all rates
-- =====================================================
...
-- =====================================================
-- 5. Fix RECIPIENTS table - allow admin users to see all recipients
-- =====================================================
...
-- =====================================================
-- 6. Fix SYSTEM_SETTINGS table - allow admin users to see settings
-- =====================================================
...
-- =====================================================
-- 7. Fix EMAIL_TEMPLATES table - allow admin users to see templates
-- =====================================================
...
-- =====================================================
-- 8. Fix ADMIN_USERS table - allow admin users to see admin users
-- =====================================================
